...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oggetto.descrizione'
        db.add_column('aste_core_oggetto', 'descrizione',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oggetto.descrizione'
        db.delete_column('aste_core_oggetto', 'descrizione')
